...
# tasks = [
#     {'goal': {0: {'inside_bellpepper_305': 1}}, 'id': 0},
#     {'goal': {0: {'on_book_111': 1}}, 'id': 0},
#     {'goal': {0: {'on_plate_210': 1}}, 'id': 1},
#     {'goal': {0: {'on_mug_199': 1}}, 'id': 1},
#     {'goal': {0: {'inside_book_158': 1}}, 'id': 2},
#     {'goal': {0: {'inside_cutleryfork_165': 1}}, 'id': 2},
#     {'goal': {0: {'inside_apple_103': 1}}, 'id': 3},
#     {'goal': {0: {'on_crackers_72': 1}}, 'id': 3},
#     {'goal': {0: {'inside_cupcake_157': 1}}, 'id': 4},
#     {'goal': {0: {'on_milk_189': 1}}, 'id': 5}, # already satisfied
# ] 

tasks = [
    {'goal': {0: {'inside_creamybuns_305': 1}}, 'id': 0} ,
    {'goal': {0: {'on_cutleryfork_238': 1}}, 'id': 0} ,
    {'goal': {0: {'on_mug_111': 1}}, 'id': 0} ,
    {'goal': {0: {'on_apple_111': 1}}, 'id': 0} ,
    {'goal': {0: {'on_wineglass_231': 1}}, 'id': 0} ,
    {'goal': {0: {'on_dishbowl_199': 1}}, 'id': 1} ,
    {'goal': {0: {'on_poundcake_86': 1}}, 'id': 1} ,
    {'goal': {0: {'inside_book_83': 1}}, 'id': 1} ,
    {'goal': {0: {'inside_fryingpan_228': 1}}, 'id': 1} ,
    {'goal': {0: {'on_plate_210': 1}}, 'id': 1} ,
    {'goal': {0: {'inside_salmon_162': 1}}, 'id': 2} ,
    {'goal': {0: {'inside_plate_165': 1}}, 'id': 2} ,
    {'goal': {0: {'inside_milk_162': 1}}, 'id': 2} ,
    {'goal': {0: {'inside_cutleryknife_165': 1}}, 'id': 2} ,
    {'goal': {0: {'turnon_163': 1}}, 'id': 2} ,
    {'goal': {0: {'on_crackers_72': 1}}, 'id': 3} ,
    {'goal': {0: {'inside_apple_103': 1}}, 'id': 3} ,
    {'goal': {0: {'inside_wineglass_104': 1}}, 'id': 3} ,
    {'goal': {0: {'inside_plate_104': 1}}, 'id': 3} ,
    {'goal': {0: {'inside_cutleryfork_104': 1}}, 'id': 3} ,
    {'goal': {0: {'on_mincedmeat_138': 1}}, 'id': 4} ,
    {'goal': {0: {'on_chocolatesyrup_138': 1}}, 'id': 4} ,
    {'goal': {0: {'inside_mincedmeat_157': 1}}, 'id': 4} ,
    {'goal': {0: {'inside_plate_156': 1}}, 'id': 4} ,
    {'goal': {0: {'inside_cupcake_157': 1}}, 'id': 4} ,
    {'goal': {0: {'on_plate_106': 1}}, 'id': 5} ,
    {'goal': {0: {'on_beer_186': 1}}, 'id': 5} ,
    {'goal': {0: {'on_cutleryknife_189': 1}}, 'id': 5} ,
